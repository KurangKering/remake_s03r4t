...
class Ion_auth_model extends CI_Model
{
	...
	{
		return $this->session->userdata('groups_array');
	}


	private function _set_groups_array()
	{
		$users_groups = $this->get_users_groups()->result();
		$groups_array = array();
		...
		if ($this->session->userdata('groups_array')) {
			$this->session->unset_userdata('groups_array');
		}
		$this->session->set_userdata( 'groups_array' , $groups_array );
